...
class Metaclass_ChangeState_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from motor_controller.msg import Transition
...
class ChangeState_Request(metaclass=Metaclass_ChangeState_Request):
    ...
    _fields_and_field_types = {
        'transition': 'motor_controller/Transition',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['motor_controller', 'msg'], 'Transition'),  # noqa: E501
    )
...
class Metaclass_ChangeState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from motor_controller.srv import _change_state
...
class ChangeState(metaclass=Metaclass_ChangeState):
    from motor_controller.srv._change_state import ChangeState_Request as Request
    from motor_controller.srv._change_state import ChangeState_Response as Response
