...
bool motor_controller__msg__state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_controller.msg._state.State", full_classname_dest, 33) == 0);
  }
  motor_controller__msg__State * ros_message = _ros_message;
  {  // id
...
PyObject * motor_controller__msg__state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_controller.msg._state");
