...
bool motor_controller__msg__motor_speeds__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("motor_controller.msg._motor_speeds.MotorSpeeds", full_classname_dest, 46) == 0);
  }
  motor_controller__msg__MotorSpeeds * ros_message = _ros_message;
  {  // m1
...
PyObject * motor_controller__msg__motor_speeds__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("motor_controller.msg._motor_speeds");
