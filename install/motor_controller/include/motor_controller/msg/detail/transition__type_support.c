  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  motor_controller__msg__Transition__init(message_memory);
}

void Transition__rosidl_typesupport_introspection_c__Transition_fini_function(void * message_memory)
{
  motor_controller__msg__Transition__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Transition__rosidl_typesupport_introspection_c__Transition_message_member_array[2] = {
  {
    ...
    offsetof(motor_controller__msg__Transition, id),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(motor_controller__msg__Transition, label),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Transition__rosidl_typesupport_introspection_c__Transition_message_members = {
  ...
  2,  // number of fields
  sizeof(motor_controller__msg__Transition),
