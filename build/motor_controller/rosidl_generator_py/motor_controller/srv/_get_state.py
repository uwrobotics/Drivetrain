...
class Metaclass_GetState_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from motor_controller.msg import State
...
class GetState_Response(metaclass=Metaclass_GetState_Response):
    ...
    _fields_and_field_types = {
        'current_state': 'motor_controller/State',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['motor_controller', 'msg'], 'State'),  # noqa: E501
    )
...
class Metaclass_GetState(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from motor_controller.srv import _get_state
...
class GetState(metaclass=Metaclass_GetState):
    from motor_controller.srv._get_state import GetState_Request as Request
    from motor_controller.srv._get_state import GetState_Response as Response
